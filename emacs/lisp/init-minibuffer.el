;;; init-minibuffer.el --- Minibuffer setups -*- lexical-binding: t; -*-
;;
;; Copyright (C) 2024 Andrés Gasson
;;
...
;; Version: 0.0.1
;; Keywords:
;; Homepage: https://github.com/frap/init-minibuffer
...
;; depends on all-the-icons package
...
;; Vertico is a minibuffer interface, that is,
;; it changes the minibuffer looks and how you interact with it.
(use-package vertico
  :ensure t
