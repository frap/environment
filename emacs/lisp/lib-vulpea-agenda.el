...
(defconst vulpea-agenda-cmd-refile
  '(tags
    "REFILE"
    ((org-agenda-overriding-header "Pour refiler")
...
(defconst vulpea-agenda-cmd-focus
  '(tags-todo
    ...
    ((org-agenda-overriding-header
      (concat "Se concentrer sur"
              (if vulpea-agenda-hide-scheduled-and-waiting-next-tasks
                  ""
                " (y compris les tâches EN ATTENTE et PROGRAMMÉES)")))
...
(defconst vulpea-agenda-cmd-waiting
  '(tags-todo
    "-ANNULÉ+ATTENDRE-READING-FOCUS|+SUSPENDU/!"
    ((org-agenda-overriding-header
